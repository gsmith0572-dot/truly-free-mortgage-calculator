        ...
        <div className="bg-white rounded-xl shadow-[0_4px_6px_-1px_rgb(0_0_0/0.1)] p-10">
          ...
          <div className="space-y-6 text-[15px] text-[#4a5568] leading-relaxed">
            ...
            <div>
              ...
              <p>For questions about this privacy policy, contact us at <a href="mailto:george@klickifyagency.com" className="text-[#0058c3] font-medium">george@klickifyagency.com</a>.</p>
            </div>
          </div>
        </div>
      </div>
